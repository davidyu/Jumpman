package
{
	...
	public class FloatingPlatform extends Actor
	{
		...
		private var _state:int = TO_START; // 0 = destination: start, 1 = not moving, 2 = destination: end
		...
		public function FloatingPlatform(canvas:DisplayObjectContainer, stage:Stage, platform_width:int, platform_height:int, start:Point, end:Point, cooldown:int)
		{
			...
			platformJoint.maxMotorForce = 4000;
